        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center">
            <nav className="flex space-x-1 mr-4">
              ...
              <Link to="/reviews-faq" className="text-white hover:bg-white/20 px-3 py-2 rounded-lg font-medium transition duration-300">Reviews & FAQ</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-indigo-800 py-4 px-4">
          <nav className="space-y-2">
            ...
            <Link to="/reviews-faq" className="block text-white hover:bg-white/20 px-3 py-2 rounded-lg font-medium transition duration-300" onClick={() => setIsMenuOpen(false)}>Reviews & FAQ</Link>
            {/* Legal News link removed */}
            {/* Assessment link removed */}
            {/* Legal Updates link removed */}
            {/* Live Sessions link removed */}
