  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Simple Reviews & FAQ Link */}
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 border border-gray-100 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Community Reviews & FAQ</h2>
          <p className="text-gray-700 mb-6">Check out what other users are saying and find answers to common questions.</p>
          <button 
            className="bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 transition duration-300 font-medium flex items-center mx-auto"
            onClick={() => navigate('/reviews-faq')}
          >
