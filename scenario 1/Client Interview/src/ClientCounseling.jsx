...
class RajeshConversationEngine {
  ...
  getSummary() {
    return {
      ...
      topicsCovered: ['background', 'incident']
    };
  }
...
const ClientInterview: React.FC = () => {
  ...
  useEffect(() => {
    conversationEngineRef.current = new RajeshConversationEngine({});
  }, []);
